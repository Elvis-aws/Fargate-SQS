...
ECS container agent
*******************
    - This allows container instances to connect to your cluster. 
    - The Amazon ECS container agent is included in the Amazon ECS-optimized AMIs, but you can also install it 
      on any Amazon EC2 instance.
    - The Amazon ECS container agent is supported on Amazon EC2 instances and external instances (on-premises 
      server or VM).
